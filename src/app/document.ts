...
const draftSchema = z.object({ spec: dashboardSchema, canvas: canvasSchema, key: z.string(), id: z.string().nullable(), revision: z.number().int().nonnegative(), source: z.string(), updated: z.string() });
