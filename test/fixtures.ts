...
export const model: Model = {
  ...
  metrics: {
    ...
    ltv_cac_ratio: { name: "ltv_cac_ratio", label: "LTV / CAC", baseTable: "fct_sales",
                     expression: "1.0", filter: null, synonyms: [] },
    logo_churn_annualized: { name: "logo_churn_annualized", label: "Logo churn (annualized)",
                             baseTable: "fct_sales", expression: "1.0", filter: null,
                             synonyms: ["annual churn", "yearly churn rate"] },
    new_signups: { name: "new_signups", label: "New signups", baseTable: "fct_sales",
                   expression: "1.0", filter: null, synonyms: ["registrations", "new accounts"] },
  },
  joins: [
